    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/reviews").hasAuthority(Role.COMPRADOR.name())

                // c) Compras
                .requestMatchers(HttpMethod.POST, "/compras").hasAuthority(Role.COMPRADOR.name())
                ...
                // Descuentos - solo ADMIN puede gestionar y ver todos los descuentos
                ...
                // Métodos de entrega - solo ADMIN puede gestionar
                ...
                // Puntos de retiro - solo ADMIN puede gestionar
